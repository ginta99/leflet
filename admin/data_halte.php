		...
		<div class="panel-body">
			<table class="table table-bordered table-hover">
				...
				<tbody>
					...
					$query = "SELECT * FROM data_halte";
					$result = mysqli_query($con, $query);
					while($row=mysqli_fetch_array($result)){
						echo '<tr>';
						echo '<td>'. $row['id_halte'] . '</td>';
						echo '<td>'. $row['nama_halte'] . '</td>';
						echo '<td>'. $row['latitude'] . '</td>';
						echo '<td>'. $row['logtitude'] .'</td>';
						echo '<td>'. $row['keterangan'] . '</td>';
						echo '<td>'. $row['id_lokasi'] . '</td>';
						echo '<td><a class="btn btn-xs btn-info" href="tampil.php?id_lokasi='. $row['id_halte'] . '"> <span class="glyphicon glyphicon-search" aria-hidden="true"></span> Read</a>
								   <a class="btn btn-xs btn-primary" href="edit.php?id_lokasi='. $row['id_halte'] . '"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Update</a>
								   <a class="btn btn-xs btn-danger" href="hapus.php?id_lokasi='. $row['id_halte'] . '"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Delete</a>
							  </td>';
						echo '</tr>';
					}
				?>
